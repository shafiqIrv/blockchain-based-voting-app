...
echo -e "${YELLOW}Step 6.3: Installing on KPU peers...${NC}"
...
echo -e "${YELLOW}Step 6.4: Getting Package ID...${NC}"
...
echo -e "${YELLOW}Step 6.5: Approving for both organizations...${NC}"
...
echo -e "${YELLOW}Step 6.6: Committing chaincode definition...${NC}"
